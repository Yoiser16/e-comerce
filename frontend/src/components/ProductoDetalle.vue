    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          ...
          <div v-else-if="carritoItems.length > 0" class="bg-gradient-to-r from-green-50 to-white cart-shipping-bar">
          ...
          <div class="flex-1 overflow-y-auto px-3 sm:px-4">
            ...
            <div v-else-if="carritoItems.length === 0" class="flex flex-col items-center justify-center text-center cart-empty">
          ...
          <div v-if="carritoItems.length > 0" class="cart-footer">
            <div class="cart-footer-summary space-y-1.5">
              <div class="cart-summary-row">
                <span>Subtotal</span>
                <span>{{ formatearPrecio(getCartSubtotal()) }}</span>
              </div>
              <div class="cart-summary-row">
                <span>Envío</span>
              ...
              <div class="cart-total-row">
                ...
                <span class="cart-total-value">{{ formatearPrecio(getCartSubtotal()) }}</span>
              </div>
            </div>
